 ...
 */
final class Version20231211151134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_36ac99f1ea9fdd75 ON link');
        $this->addSql('CREATE INDEX IDX_36AC99F1EA9FDD75 ON link (media_id)');
        $this->addSql('DROP INDEX fk_36ac99f112469de2 ON link');
        ...
        $this->addSql('ALTER TABLE media ADD status VARCHAR(20) DEFAULT \'pending\' NOT NULL, CHANGE parent_id parent_id INT NOT NULL, CHANGE country_id country_id INT NOT NULL, CHANGE category category VARCHAR(150) NOT NULL, CHANGE visitors_count visitors_count INT NOT NULL, CHANGE email email VARCHAR(150) NOT NULL, CHANGE language_id language_id INT NOT NULL, CHANGE facebook_followers_count facebook_followers_count INT DEFAULT NULL, CHANGE twitter_followers_count twitter_followers_count INT DEFAULT NULL, CHANGE instagram_followers_count instagram_followers_count INT DEFAULT NULL, CHANGE youtube_followers_count youtube_followers_count INT DEFAULT NULL, CHANGE domain domain VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_36AC99F1EA9FDD75 ON link (media_id)');
        $this->addSql('DROP INDEX idx_36ac99f112469de2 ON link');
        $this->addSql('CREATE INDEX FK_36AC99F112469DE2 ON link (category_id)');
        $this->addSql('ALTER TABLE link ADD CONSTRAINT FK_36AC99F1EA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id)');
        $this->addSql('ALTER TABLE link ADD CONSTRAINT FK_36AC99F112469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        ...
        $this->addSql('ALTER TABLE media DROP status, CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE country_id country_id INT DEFAULT NULL, CHANGE language_id language_id INT DEFAULT NULL, CHANGE category category VARCHAR(150) DEFAULT NULL, CHANGE visitors_count visitors_count INT DEFAULT NULL, CHANGE email email VARCHAR(150) DEFAULT NULL, CHANGE facebook_followers_count facebook_followers_count INT DEFAULT 0, CHANGE twitter_followers_count twitter_followers_count INT DEFAULT 0, CHANGE instagram_followers_count instagram_followers_count INT DEFAULT 0, CHANGE youtube_followers_count youtube_followers_count INT DEFAULT 0, CHANGE domain domain VARCHAR(255) DEFAULT NULL');
