 ...
 */
final class Version20231212015408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compaign ADD parent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE compaign ADD CONSTRAINT FK_4F2A6980727ACA70 FOREIGN KEY (parent_id) REFERENCES compaign (id)');
        $this->addSql('CREATE INDEX IDX_4F2A6980727ACA70 ON compaign (parent_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compaign DROP FOREIGN KEY FK_4F2A6980727ACA70');
        $this->addSql('DROP INDEX IDX_4F2A6980727ACA70 ON compaign');
        $this->addSql('ALTER TABLE compaign DROP parent_id');
