 ...
 */
class CronJob extends \Cron\CronBundle\Entity\CronJob implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'id', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'name', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'command', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'schedule', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'description', '' . "\0" . 'Cron\\CronBundle\\Entity\\CronJob' . "\0" . 'enabled', 'reports'];
        }
