...
class getLanguageRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\LanguageRepository'])) {
            return $container->privates['App\\Repository\\LanguageRepository'];
        }

        return $container->privates['App\\Repository\\LanguageRepository'] = new \App\Repository\LanguageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), $a);
    }
}
