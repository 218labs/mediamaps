...
class __TwigTemplate_6cff70050717ec7ff4b9ec90f6df058d06b9f496fd2ff53abfae8b8d64a7b972 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"sf-tabs\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["client"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 76, $this->source); })()), "countClientMessages", [$context["client"]], "method", false, false, false, 76), "html", null, true);
            echo "</span></h3>
            ...
            // line 83
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 83, $this->source); })()), "clientRootStacks", [$context["client"]], "method", false, false, false, 83));
            $context['loop'] = [
...
{% endblock %}
", "@Httplug/webprofiler.html.twig", "C:\\xampp\\htdocs\\Symfony\\mediamaps\\vendor\\php-http\\httplug-bundle\\src\\Resources\\views\\webprofiler.html.twig");
    }
}
