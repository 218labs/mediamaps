...
class __TwigTemplate_72896b50195d54f32c4a7ec67549584be8aceccf203f497f7234a08bbd1e4b49 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
  ...
  <div class=\"row mb-4\">
    ...
    <div class=\"col-lg-3 col-3\">
      <div class=\"float-end\">
        <ajax-modal url=\"{{ path('categories.create') }}\" class=\"add-new\">
          <button class=\"btn btn-outline-primary rounded-0 shadow-none\">
            <i class=\"bi bi-plus\"></i>
...
{% block footer %}
  ...
  {% endif %}
{% endblock %}
", "admin/category/index.html.twig", "C:\\xampp\\htdocs\\Symfony\\mediamaps\\templates\\admin\\category\\index.html.twig");
    }
}
