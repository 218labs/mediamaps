...
class getSecurity_Firewall_Authenticator_SecuredAreaService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.authenticator.secured_area'] = new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([0 => ($container->privates['security.authenticator.guard.secured_area.0'] ?? $container->load('getSecurity_Authenticator_Guard_SecuredArea_0Service')), 1 => ($container->privates['security.authenticator.oauth.secured_area'] ?? $container->load('getSecurity_Authenticator_Oauth_SecuredAreaService'))], ($container->services['.container.private.security.token_storage'] ?? $container->get_Container_Private_Security_TokenStorageService()), ($container->privates['security.event_dispatcher.secured_area'] ?? $container->getSecurity_EventDispatcher_SecuredAreaService()), 'secured_area', ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), true, true, []));
    }
}
